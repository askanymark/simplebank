...
// 	protoc        v6.33.2
// source: users/rpc_login_user.proto
...
func (x *LoginUserRequest) Reset() {
	*x = LoginUserRequest{}
	mi := &file_users_rpc_login_user_proto_msgTypes[0]
...
func (*LoginUserRequest) Descriptor() ([]byte, []int) {
	return file_users_rpc_login_user_proto_rawDescGZIP(), []int{0}
}
...
func (x *LoginUserResponse) Reset() {
	*x = LoginUserResponse{}
	mi := &file_users_rpc_login_user_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LoginUserResponse) Descriptor() ([]byte, []int) {
	return file_users_rpc_login_user_proto_rawDescGZIP(), []int{1}
}
...
var File_users_rpc_login_user_proto protoreflect.FileDescriptor

var file_users_rpc_login_user_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2f, 0x72, 0x70, 0x63, 0x5f, 0x6c, 0x6f, 0x67, 0x69,
	0x6e, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x70, 0x62,
	0x1a, 0x1f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75,
	0x66, 0x2f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x1a, 0x10, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x70, 0x72,
...
var (
	file_users_rpc_login_user_proto_rawDescOnce sync.Once
	file_users_rpc_login_user_proto_rawDescData = file_users_rpc_login_user_proto_rawDesc
)

func file_users_rpc_login_user_proto_rawDescGZIP() []byte {
	file_users_rpc_login_user_proto_rawDescOnce.Do(func() {
		file_users_rpc_login_user_proto_rawDescData = protoimpl.X.CompressGZIP(file_users_rpc_login_user_proto_rawDescData)
	})
	return file_users_rpc_login_user_proto_rawDescData
}

var file_users_rpc_login_user_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_users_rpc_login_user_proto_goTypes = []any{
	(*LoginUserRequest)(nil),      // 0: pb.LoginUserRequest
	(*LoginUserResponse)(nil),     // 1: pb.LoginUserResponse
	(*User)(nil),                  // 2: pb.User
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_users_rpc_login_user_proto_depIdxs = []int32{
...
func init() { file_users_rpc_login_user_proto_init() }
func file_users_rpc_login_user_proto_init() {
	if File_users_rpc_login_user_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_users_rpc_login_user_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_users_rpc_login_user_proto_goTypes,
		DependencyIndexes: file_users_rpc_login_user_proto_depIdxs,
		MessageInfos:      file_users_rpc_login_user_proto_msgTypes,
	}.Build()
	File_users_rpc_login_user_proto = out.File
	file_users_rpc_login_user_proto_rawDesc = nil
	file_users_rpc_login_user_proto_goTypes = nil
	file_users_rpc_login_user_proto_depIdxs = nil
}
